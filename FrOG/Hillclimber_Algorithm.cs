...
namespace FrOG
{
    public class Hillclimber_Algorithm
    {
        ...
        public Hillclimber_Algorithm(double [] lb, double [] ub, double stepsize, int itermax, Func<double[], double> evalfnc, int seed)
        {
            this.lb = lb;
            this.ub = ub;
